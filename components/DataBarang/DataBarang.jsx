        ...
        <table className="min-w-full border-collapse border border-gray-300">
          <thead>
            <tr className="bg-gray-100">
              ...
              <th className="border border-gray-300 p-2">Jenis Barang</th>
            ...
            {items && items.length > 0 ? (
              items.map((item, index) => (
                <tr key={index} className="hover:bg-gray-50">
                  ...
                  <td className="border border-gray-300 p-2">{item.jenisBarang}</td>
                  <td className="border border-gray-300 p-2">{item.harga}</td>
